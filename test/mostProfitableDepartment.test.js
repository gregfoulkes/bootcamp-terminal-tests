...
it ('Should return outdoor', function(){
  ...
  it ('Should return hardware', function(){
    ...
    var salesData = [
      {department : 'hardware', sales : 45000, day : 'Monday'},
      {department : 'outdoor', sales : 1500, day : 'Monday'},
      {department : 'carpentry', sales : 5500, day : 'Monday'},
      {department : 'hardware', sales : 10000, day : 'Tuesday'},
      {department : 'outdoor', sales : 2505, day : 'Tuesday'},
      {department : 'carpentry', sales : 1540, day : 'Tuesday'},
      ...
      {department : 'outdoor', sales : 18007, day : 'Thursday'},
      {department : 'carpentry', sales : 6109, day : 'Thursday'},
      {department : 'hardware', sales : 70050, day : 'Friday'},
      {department : 'outdoor', sales : 12006, day : 'Friday'},
      {department : 'carpentry', sales : 16109, day : 'Friday'}
  ];

      var dept = mostProfitableDepartment(salesData);
      assert.equal(dept ,'hardware')
